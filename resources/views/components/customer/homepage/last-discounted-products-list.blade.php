@if (isset($products))
    <div class="w-full flex flex-nowrap flex-col rounded-2xl border border-gray-300 relative py-5 bg-surface gap-5"
        ...
        <div class="px-5">
            <div
                class="flex justify-between items-center rounded-xl font-shabnam px-5 bg-gradient-to-l from-primary to-primary-dark py-5">
                <h3 class="text-surface lg:text-lg font-[500]">هیچی نیست! عجله نکن</h3>
                <a href="{{ route('customer.products') }}"
                    class="flex items-center cursor-pointer text-surface text-xs lg:text-sm gap-2" wire:navigate>
