...
<div class="opened-panel">
    <div class="inner-container flex! flex-col! gap-5 min-h-screen pb-5" x-data="product()"
        x-on:success.window="patterns = [];
                        generalInfo = {
                            name: '',
                            englishName: '',
                            brand: '',
        ...
        <x-blade.manager.section class="title-con h-25">
            ...
            <x-blade.manager.filled-button value="انتشار محصول" icon="paper-plane" target="create"
                x-on:click="sendData()" />
        ...
        <div class="w-full flex gap-5 flex-nowrap">
            ...
            <x-blade.manager.section class="w-2/3 h-91 shrink-1!">
                ...
                <div class="w-full flex gap-5">
                    ...
                    <x-blade.manager.input-text title="قیمت" required name="form.price" label="تومان"
                        x-init="priceFormat($el)" dir="ltr" />
                </div>
            ...
            <div class="w-1/3 flex flex-col gap-5">
                ...
                <div class="w-full h-fit section shrink-0">
                    <x-blade.manager.section-title title="سطح‌بندی محصول" />
                    <div class="w-full flex flex-nowrap gap-5">
                        <div class="w-full">
                            <input type="radio" class="peer hidden" wire:model.live="form.level" name="level"
                            ...
                            <label
                                ...
                                x-on:click="$wire.set('form.level', 'gold')">
                                طلایی
                            </label>
                        </div>
                        <div class="w-full">
                            ...
                            <label
                                class="w-full border-2 border-gray-200 peer-checked:border-blue-700 rounded-lg peer-checked:bg-blue-50 bg-gray-50 h-13 flex items-center justify-center font-shabnam text-lg gap-3 cursor-pointer"
                                x-on:click="$wire.set('form.level', 'silver')">
                                نقره‌ای
                            </label>
                        </div>
                        <div class="w-full">
                            ...
                            <label
                                class="w-full border-2 border-gray-200 peer-checked:border-blue-700 rounded-lg peer-checked:bg-blue-50 bg-gray-50 h-13 flex items-center justify-center font-shabnam text-lg gap-3 cursor-pointer"
                                x-on:click="$wire.set('form.level', 'boronze')">
                                برنزی
                            </label>
                        </div>
                    </div>
        ...
        <div class="section h-fit select-none">
            ...
            <div class="w-full h-full flex flex-col gap-6">
                ...
                <template x-if="patterns.length">
                    <div class="flex gap-3 h-12 border-b-1 border-gray-200 overflow-x-auto">
                        <template x-for="(pattern, index) in patterns">
                            <div class="h-full w-fit px-4 bg-gray-50 border-b-3 shrink-0 border-transparent flex items-center justify-center gap-3 box-border font-[shabnam] rounded-t-xl hover:bg-gray-100 transition-[background-color] text-lg cursor-pointer font-light relative"
                                ...
                                <div class="absolute size-3 bg-red-600 rounded-full top-0.5 -left-0.5"
                                                ...
                                                {{-- <div class="w-full flex flex-col gap-5">
                                                    ...
                                                    <div class="font-[shabnam] flex items-center gap-2"
                                                        ...
                                                        <span class="text-xl" x-data="{ finalPrice: 0 }"
                                                            x-init="$watch('size.price', value => finalPrice = Intl.NumberFormat('fa-IR').format(size.price.replace(/,/g, '').replace(/[^\d]/g, '') - size.discount.replace(/,/g, '').replace(/[^\d]/g, '')));
                                                            $watch('size.discount', value => finalPrice = Intl.NumberFormat('fa-IR').format(size.price.replace(/,/g, '').replace(/[^\d]/g, '') - size.discount.replace(/,/g, '').replace(/[^\d]/g, '')))" x-text="finalPrice"></span>
                                        ...
                                        <div class="w-full h-auto flex flex-col flex-nowrap gap-5 -mt-[1px]">
                                            {{-- <div class="w-full flex flex-col gap-5">
                                                ...
                                                <div class="font-[shabnam] flex items-center gap-2"
                                                    ...
                                                    <span class="text-gray-700">قیمت نهایی:</span>
                                                    <span class="text-xl" x-data="{ finalPrice: 0 }"
                                                        x-init="$watch('noPattern.noSizeVariants.price', value => finalPrice = Intl.NumberFormat('fa-IR').format(noPattern.noSizeVariants.price.replace(/,/g, '').replace(/[^\d]/g, '') - noPattern.noSizeVariants.discount.replace(/,/g, '').replace(/[^\d]/g, '')));
                                                        $watch('noPattern.noSizeVariants.discount', value => finalPrice = Intl.NumberFormat('fa-IR').format(noPattern.noSizeVariants.price.replace(/,/g, '').replace(/[^\d]/g, '') - noPattern.noSizeVariants.discount.replace(/,/g, '').replace(/[^\d]/g, '')))" x-text="finalPrice"></span>
                                                    <span class="text-gray-400 text-sm">تومان</span>
                                                </div>
                                            </div> --}}
                                            <div class="w-full flex gap-5 flex-nowrap shrink-0">
                                                <div class="w-full" x-data="{ errorMessage: '' }"
                                                    x-on:validate.window="if (!noPattern.noSizeVariants.quantity.trim()) { errorMessage = 'موجودی الزامی می‌باشد.'; noPattern.noSizeVariants.validated = true }">
                                                    <x-blade.manager.input-text type="text" inputmode="numeric"
                                                        dir="ltr" title="موجودی کالا" min="0"
                ...
                <template x-if="patterns.length">
                    <template x-for="(pattern, index) in patterns">
                        <div class="flex flex-col gap-5 flex-nowrap" x-show="currentPatternTab == index"
                            ...
                            <div class="flex gap-5 flex-nowrap">
                                <div class="w-full rounded-lg flex flex-col gap-5" x-data="{ showErrorPatternName: false }"
                                    x-on:validate.window="if (!pattern.name.length) { showErrorPatternName = true; pattern.validated = false } else showErrorPatternName = false">
                                    ...
                                    <div class="w-full h-auto flex flex-col gap-1 flex-nowrap"
                                        ...
                                        {{-- <div
                                            class="font-[shabnam] text-gray-500 text-sm flex items-center flex-nowrap gap-2"
                                            x-bind:class="{ 'mt-3': pattern.colors.length }" x-show="!showErrorColors">
                                            <i class="fa-solid fa-info-circle"></i>
                                            <span>
                                                هر طرح می‌تواند یک یا چند رنگ ساده داشته باشد، اما برای مشتری به‌عنوان
                                                یک
                                                رنگ واحد نمایش داده می‌شود.
                                            </span>
                                        </div> --}}
                                    ...
                                    <div class="w-full flex flex-col gap-5 flex-nowrap" x-data="{ currentSizeTab: 0 }">
                                        <x-blade.manager.section-title title="مشخصات فروش" class="select-none" />
                                        <div x-show="pattern.sizes.length">
                                            <div class="w-full h-fit font-[shabnam]">
                                                <div class="w-full h-10 flex flex-nowrap gap-2 z-2">
                                                ...
                                                <template x-for="(size, index) in pattern.sizes">
                                                    <div class="border-1 border-gray-200 rounded-lg rounded-tr-none w-full h-auto flex flex-col flex-nowrap p-5 gap-5 -mt-[1px]"
                                                        ...
                                                        {{-- <div class="w-full flex flex-col gap-5">
                                                            <div class="w-full flex gap-5 flex-nowrap shrink-0">
                                                                <div class="w-full" x-data="{ errorMessage: '' }"
                                                                    x-on:validate.window="if (!size.price.trim()) { errorMessage = 'قیمت الزامی می‌باشد.'; pattern.validated = false } else errorMessage = ''">
                                                                    <x-blade.manager.input-text inputmode="numeric"
                                                            ...
                                                            <div class="font-[shabnam] flex items-center gap-2"
                                                                ...
                                                                <span class="text-xl" x-data="{ finalPrice: 0 }"
                                                                    x-init="$watch('size.price', value => finalPrice = Intl.NumberFormat('fa-IR').format(size.price.replace(/,/g, '').replace(/[^\d]/g, '') - size.discount.replace(/,/g, '').replace(/[^\d]/g, '')));
                                                                    $watch('size.discount', value => finalPrice = Intl.NumberFormat('fa-IR').format(size.price.replace(/,/g, '').replace(/[^\d]/g, '') - size.discount.replace(/,/g, '').replace(/[^\d]/g, '')))"
                                                        ...
                                                        <div class="w-full flex items-center gap-5 flex-nowrap">
                                                            <div class="w-full" x-data="{ errorMessage: '' }"
                                                                x-on:validate.window="if (!size.quantity.trim()) { errorMessage = 'موجودی الزامی می‌باشد.'; pattern.validated = false } else errorMessage = ''">
                                            ...
                                            <div class="w-full h-fit font-[shabnam]">
                                                <div class="w-full h-auto flex flex-col flex-nowrap gap-5 -mt-[1px]">
                                                    {{-- <div class="w-full flex flex-col gap-5">
                                                        <div class="w-full flex gap-5 flex-nowrap shrink-0">
                                                            <div class="w-full" x-data="{ errorMessage: '' }"
                                                                x-on:validate.window="if (!pattern.noSizeVariants.price.trim()) { errorMessage = 'قیمت الزامی می‌باشد.'; pattern.validated = false } else errorMessage = ''">
                                                                <x-blade.manager.input-text inputmode="numeric"
                                                                    title="قیمت" class="hide-arrows" dir="ltr"
                                                                    x-model="pattern.noSizeVariants.price" required
                                                                    label="تومان" x-ref="priceInput" max="11"
                                                        ...
                                                        <div class="font-[shabnam] flex items-center gap-2"
                                                            ...
                                                            <span class="text-gray-700">قیمت نهایی:</span>
                                                            <span class="text-xl" x-data="{ finalPrice: 0 }"
                                                                x-init="$watch('pattern.noSizeVariants.price', value => finalPrice = Intl.NumberFormat('fa-IR').format(pattern.noSizeVariants.price.replace(/,/g, '').replace(/[^\d]/g, '') - pattern.noSizeVariants.discount.replace(/,/g, '').replace(/[^\d]/g, '')));
                                                                $watch('pattern.noSizeVariants.discount', value => finalPrice = Intl.NumberFormat('fa-IR').format(pattern.noSizeVariants.price.replace(/,/g, '').replace(/[^\d]/g, '') - pattern.noSizeVariants.discount.replace(/,/g, '').replace(/[^\d]/g, '')))" x-text="finalPrice"></span>
                                                            <span class="text-gray-400 text-sm">تومان</span>
                                                        </div>
                                                    </div> --}}
                                                    <div class="w-full flex items-center gap-5 flex-nowrap">
                                                        <div class="w-full" x-data="{ errorMessage: '' }"
                                                            x-on:validate.window="if (!pattern.noSizeVariants.quantity.trim()) { errorMessage = 'موجودی الزامی می‌باشد.'; pattern.validated = false } else errorMessage = ''">
                                                            <x-blade.manager.input-text type="text"
                                                                inputmode="numeric" dir="ltr"
                                                                title="موجودی کالا" min="0"
                                ...
                                <div class="w-full h-auto min-h-32 rounded-lg gap-5 flex flex-nowrap flex-col"
                                    x-data="{ showError: false }"
                                    x-on:validate.window="if (!pattern.images.length) { showError = true; pattern.validated = false } else showError = false">
                                    <span class=" font-[shabnam] text-lg text-gray-800">
                                        تصاویر:
                                        <span class="text-red-700 font-normal">*</span>
                                    </span>
        ...
        <x-blade.manager.section class="h-fit" x-data="{ showSelectAttributeGroupMenu: false }">
            ...
            <div class="relative">
                <x-blade.manager.input-text title="نام مجموعه ویژگی‌ها" class="w-70!"
                    ...
                    x-ref="attributeGroupInput" x-on:success.window="$el.value = ''" />
...
<script>
    ...
    function product() {
        return {
            ...
            updateImages() {
                this.selectedImages = this.patterns.length && this.patterns[this.currentPatternTab].images.length ? [...
                    this.patterns[this.currentPatternTab].images.map(item => item.id)
                ] : [];
            },
            generalInfo: {
                name: '',
            ...
            addPattern() {
                const newPattern = {
                    ...
                    images: this.sharedImages && this.patterns.length ? [...this.patterns[this
                        .currentPatternTab].images] : [],
                };
            ...
            sendData() {
                ...
                this.$wire.create(this.generalInfo, this.selectedCategories, this.sendPatterns, this
                    .selectedAttributeGroup ? {
                        id: this.selectedAttributeGroup.id,
                        items: this.selectedAttributeGroup.attributes.filter(attribute => {
                            return attribute['value']
                        })
                    } : null, this.allValidated).then(() => {
                    this.patterns.forEach(pattern => {
