<form class="opened-panel create-category-panel" wire:submit.prevent="update" x-on:click="selectedImage = null"
    ...
    <div class="inner-container">
        <div class="items title-con">
            ...
            <div class="buttons-section">
                <x-blade.manager.filled-button type="submit" value="تایید ویرایش" target="update" />
            </div>
        </div>
